...
public class bettingAid {
    ...
    public static float homeOdds, drawOdds, awayOdds, homeWin, drawWin, awayWin, inplayHomeWin, inplayDrawWin, inplayAwayWin = 0.0f;
    public static String homeTeam, awayTeam, homeDraw, homeAway, drawHome, drawAway, awayDraw, awayHome;
    public static float stake = 50.0f;
